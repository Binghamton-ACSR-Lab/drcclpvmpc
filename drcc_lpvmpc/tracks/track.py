...
from drcc_lpvmpc.tracks.utils.projection import Projection
from drcc_lpvmpc.tracks.utils.pycubicspline import Spline, Spline2D
...
class Track:
	...
	def _plot(self, color='g', grid=True, figsize=(6.4, 4.8)):
		...
		plt.plot(self.x_outer, self.y_outer, color, lw=2, alpha=1)
		plt.plot(self.x_inner, self.y_inner, color, lw=2, alpha=1)
